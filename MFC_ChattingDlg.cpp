...
// MFC_ChattingDlg.cpp: 구현 파일
//

#include "pch.h"
#include "framework.h"
#include "MFC_Chatting.h"
...
CMFCChattingDlg::CMFCChattingDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_MFC_CHATTING_DIALOG, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CMFCChattingDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
...
// CMFCChattingDlg 메시지 처리기

BOOL CMFCChattingDlg::OnInitDialog()
{
...
void CMFCChattingDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//  이 함수를 호출합니다.
HCURSOR CMFCChattingDlg::OnQueryDragIcon()
{
